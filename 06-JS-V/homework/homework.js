...
function crearUsuario() {
  ...
  // Debe aceptar un objeto "opciones" con las propiedades "usuario", "nombre", "email" 
  //y "password"
...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function(){
    var tamaño = this.length;
    var cadenaReverse = "";

    while (tamaño >= 0) {
      cadenaReverse = cadenaReverse + this.charAt(tamaño);
      tamaño--;
    }
...
function agregarMetodo() {
  ...
  Persona.prototype.datos = function(){
    var dato = "";
    dato = this.nombre +", "+this.edad+" años";
    return dato; 
  }
}
